...
3. Java Code: 
   ...
   a. Tourist recommendation system: A desktop application to provide recommendations to tourist of attractions in Singapore using rule-based reasoning in C language integrated production system(CLIPS).
