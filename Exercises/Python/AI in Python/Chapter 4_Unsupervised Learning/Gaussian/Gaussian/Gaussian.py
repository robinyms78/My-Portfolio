...
indices.get_n_splits(iris.data, iris.target)
...
# Build GMM
classifier = GMM(n_components=sum_classes, covariance_type="full", init_params="wc", n_iter=20)
...
for i, color in enumerate(colors):
    ...
    # Draw the ellipse
    ellipse = patches.Ellipse(classifier.names_[i, :2], eigenvalues[0], eigenvalues[1], 180 + angle, color = color)
