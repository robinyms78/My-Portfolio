...
#include "SRI/SRIEmbodiment/SensorDefinition.h"


namespace SRI{

INST_EMBODIMENT_TEMPL SRI::Map<SRI::String, ActuatorDefinition>;
INST_EMBODIMENT_TEMPL SRI::Map<SRI::String, SensorDefinition>;

class EMBODIMENT_API EmbodimentDefinition: public ComponentDefinition{
