...
#include "SRI/SRIAgent/Actuator.h"
#include "SRI/SRIAgent/Sensor.h"
#include "SRI/SRIUtil/SRIMap.h"
#include "SRI/SRIUtil/SRIRef.h"
#include "SRI/SRIEngine/SRIEngineHandle.h"
#include "SRI/SRIAgent/EmbodimentDefinition.h"
#include "SRI/SRIEngine/ReactiveComponent.h"

namespace SRI{

INST_AGENT_TEMPL SRI::Map<SRI::String, SRI::Ref<SRI::Actuator>>;
INST_AGENT_TEMPL SRI::Map<SRI::String, SRI::Ref<SRI::Sensor>>;

class AGENT_API Embodiment: public ReactiveComponent{
