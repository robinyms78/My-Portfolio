...
import static com.bizconnectivity.gino.ConstantWS.WS_RETRIEVE_USER_DEAL_BY_CATEGORY;

public class RetrieveUserDealByCategoryWS {

    public static List<Deal> invokeRetrieveUserDealByCategory(int memberId, int dealCategoryId) {

        List<Deal> dealList = new ArrayList<>();

        //create request
        SoapObject request = new SoapObject(NAMESPACE, WS_RETRIEVE_USER_DEAL_BY_CATEGORY);
        ...
        try {
            androidHttpTransport.call(SOAP_ACTION + WS_RETRIEVE_USER_DEAL_BY_CATEGORY, envelope);

            if (envelope.bodyIn instanceof SoapFault) {

                Log.d("TAG", "invokeRetrieveUserDealByCategory: " + envelope.bodyIn.toString());
