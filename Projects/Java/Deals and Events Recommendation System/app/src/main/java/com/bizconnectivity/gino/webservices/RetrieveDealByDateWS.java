...
import static com.bizconnectivity.gino.ConstantWS.WS_RETRIEVE_DEAL_BY_CREATED_DATE;

public class RetrieveDealByDateWS {

    public static List<Deal> invokeRetrieveDealByDate() {

        List<Deal> dealList = new ArrayList<>();

        //create request
        SoapObject request = new SoapObject(NAMESPACE, WS_RETRIEVE_DEAL_BY_CREATED_DATE);
        ...
        try {
            androidHttpTransport.call(SOAP_ACTION + WS_RETRIEVE_DEAL_BY_CREATED_DATE, envelope);

            if (envelope.bodyIn instanceof SoapFault) {

                Log.d("TAG", "invokeRetrieveDealByDate: " + envelope.bodyIn.toString());
