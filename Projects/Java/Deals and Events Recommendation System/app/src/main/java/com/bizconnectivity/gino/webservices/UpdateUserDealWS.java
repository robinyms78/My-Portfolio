...
import static com.bizconnectivity.gino.ConstantWS.WS_UPDATE_USER_DEAL;

public class UpdateUserDealWS {

    public static boolean invokeUpdateUserDeal(int memberDealId) {
        ...
        try {
            ...
            if (envelope.bodyIn instanceof SoapFault) {
                ...
                Log.d("TAG", "invokeUpdateUserDeal: " + envelope.bodyIn.toString());
