...
import static com.bizconnectivity.gino.ConstantWS.WS_RETRIEVE_SEARCH_DEAL;

public class RetrieveSearchDealWS {

    public static List<Deal> invokeRetrieveSearchDeal(String data) {

        List<Deal> dealList = new ArrayList<>();

        //create request
        SoapObject request = new SoapObject(NAMESPACE, WS_RETRIEVE_SEARCH_DEAL);
        ...
        try {
            androidHttpTransport.call(SOAP_ACTION + WS_RETRIEVE_SEARCH_DEAL, envelope);

            if (envelope.bodyIn instanceof SoapFault) {

                Log.d("TAG", "invokeRetrieveSearchDeal: " + envelope.bodyIn.toString());
